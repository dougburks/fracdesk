...
# Inspiration
Inspired by [DHH](https://dhh.dk/) and his [Omarchy](https://omarchy.org/) setup, this is my own personal recipe for my ideal desktop environment. Like a fractal, FracDesk is simple yet powerful and beautiful. It is a curated collection of comprehensive components that balances the ideals of productivity, flexibiliity, and beauty.
